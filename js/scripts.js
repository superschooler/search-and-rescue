...
function formSubmit() {
	document.getElementById("application-form").innterHTML.write = "Thank you! Your answers have been recorded. Please be patient while we contact you regarding the next steps. We generally hold orientation and testing for new members once per year and will contact you prior to these events."
}